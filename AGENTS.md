...
| El número que da `migrate-new` sirve | Usa la hora real. Si queda por debajo de una migración ya aplicada, goose la ignora en silencio: el `down` no la revierte. Renómbrala |
